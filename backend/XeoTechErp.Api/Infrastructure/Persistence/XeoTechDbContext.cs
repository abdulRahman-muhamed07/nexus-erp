...
public sealed class XeoTechDbContext(DbContextOptions<XeoTechDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureMoney<Order>(modelBuilder);
        ConfigureMoney<Quote>(modelBuilder);
    ...
    private static void ConfigureMoney<TEntity>(ModelBuilder modelBuilder) where TEntity : class
    {
        modelBuilder.Entity<TEntity>().Property("Subtotal").HasPrecision(18, 2);
        modelBuilder.Entity<TEntity>().Property("Tax").HasPrecision(18, 2);
        modelBuilder.Entity<TEntity>().Property("Shipping").HasPrecision(18, 2);
        modelBuilder.Entity<TEntity>().Property("Total").HasPrecision(18, 2);
    }
}
